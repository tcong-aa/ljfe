var width = Math.ceil(document.body.clientWidth * 0.65),
    // height = Math.ceil(width / 1.92);
    height = Math.ceil(width / 1.6);

document.getElementById('message').style.fontSize =Math.ceil((width * 0.25) / 350 * 10) + 'px';
console.log(document.body.clientWidth);
console.log(document.getElementById('message').style.fontSize);
...
// rsi
    ...
    dim.ohlc = { height: (dim.plot.height - 14) * 0.73 };
    dim.indicator = { height: (dim.plot.height - 14) * 0.27, padding: 5 };
